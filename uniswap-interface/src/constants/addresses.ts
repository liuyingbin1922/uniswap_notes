...
export const SWAP_ROUTER_ADDRESSES: AddressMap = constructSameAddressMap('0x83bdBF0E2a1bB872cA5803ed138Bd2fD0aef50B4', [
  SupportedChainId.OPTIMISM,
  SupportedChainId.OPTIMISTIC_KOVAN,
  SupportedChainId.ARBITRUM_ONE,
  SupportedChainId.ARBITRUM_RINKEBY,
...
export const QUOTER_ADDRESSES: AddressMap = constructSameAddressMap('0x83bdBF0E2a1bB872cA5803ed138Bd2fD0aef50B4', [
  SupportedChainId.OPTIMISM,
  SupportedChainId.OPTIMISTIC_KOVAN,
  SupportedChainId.ARBITRUM_ONE,
  SupportedChainId.ARBITRUM_RINKEBY,
...
export const NONFUNGIBLE_POSITION_MANAGER_ADDRESSES: AddressMap = constructSameAddressMap(
  '0x83bdBF0E2a1bB872cA5803ed138Bd2fD0aef50B4',
  [
    SupportedChainId.OPTIMISM,
    SupportedChainId.OPTIMISTIC_KOVAN,
    SupportedChainId.ARBITRUM_ONE,
